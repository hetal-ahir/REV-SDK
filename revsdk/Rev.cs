...
namespace revCore
{
    ...
    {
        /// <summary>
        /// Give list of all repositiory in your workspace with Repositiory name and id
        /// </summary>
        /// <returns></returns> List of all Repositiory name
        /// 
        Task<IReadOnlyDictionary<string, string>> ensureProjectLoadedAsync();

        /// <summary>
        /// Create new repositiory in your workspace
        /// </summary>
        /// <param name="name"></param>  Name for repositiory
        /// <param name="fields"></param>  Indexing field of repo
        /// <returns></returns> Create new Repo with given indexing feilds       
        Task<string> CreateRepoAsync(string name, RevField[] fields);

        /// <summary>
        /// Search documents based on repositiory name and indexing field
        /// </summary>
        /// <param name="repoName"></param> Repositiory name
        /// <param name="values"></param> Indexing field value. Bydefault it will be NULL
        /// <returns></returns> List of all documents with total pages in each document
        /// 
        IEnumerable<RevDoc> SearchDocs(string repoName, Dictionary<string, string> values = null);

        /// <summary>
        /// Delete document based on given document id
        /// </summary>
        /// <param name="docId"></param> Document id which you want to delete
        /// <returns></returns> Delete document 
        Task DeleteDocumentAsync(string docId);

        /// <summary>
        /// Create new document in selected repo
        /// </summary>
        /// <param name="projectName"></param> Repo name
        /// <param name="indexes"></param> Indexing feild name
        /// <param name="pages"></param> Pages details
        /// <param name="otherParams"></param> other optional fields. Bydefault it will be NULL
        /// <returns></returns> create new documet 
        Task<string> CreateDocumentAsync(string projectName, IReadOnlyDictionary<string, string> indexes, ExistingPage[] pages, Dictionary<string, object> otherParams = null);

        /// <summary>
        /// Create new documet in selected repo.
        /// It will call Task<string> CreateDocumentAsync(string projectName, IReadOnlyDictionary<string, string> indexes, ExistingPage[] pages, Dictionary<string, object> otherParams = null) 
        /// function and for that it will create new page details and pass it to function.
        /// </summary>
        /// <param name="projectName"></param> Repository name
        /// <param name="indexes"></param> Indexing fields
        /// <param name="files"></param> Files details
        /// <returns></returns> create new document
        Task<string> CreateDocument(string projectName, IReadOnlyDictionary<string, string> indexes, FileInfo[] files);
    ...
    public class Rev
    {
        ...
        /// </summary>
        /// <returns></returns>
        async Task<IReadOnlyDictionary<string, string>> ensureProjectLoadedAsync()
        {
